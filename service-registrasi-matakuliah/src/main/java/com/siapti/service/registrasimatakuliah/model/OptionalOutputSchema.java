...
public class OptionalOutputSchema {
	...
	Optional<RegistrasiMatakuliah> output_schema;
	...
	public Optional<RegistrasiMatakuliah> getOutput_schema() {
		return output_schema;
	}

	public void setOutput_schema(Optional<RegistrasiMatakuliah> output_schema) {
